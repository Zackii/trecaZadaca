...
public class RegresijaSustava {
	...
	private static final double[] FUNCTION_LINE = new double[] { -0.160, 2.320, -3.500, -2.660, 4.620,
			-171.36699979479872 };
	...
	public static void main(String[] args) {
		...
		if (args[1].equals("decimal")) {
			...
			DoubleArraySolution solution = new SimulatedAnnealing<DoubleArraySolution>(decoder, neighborhood, startWith,
					function, minimize, schedule).run();
			
			for(int i = 0; i < 6; i++) {
				System.out.print(solution.values[i] + " ");
			}
